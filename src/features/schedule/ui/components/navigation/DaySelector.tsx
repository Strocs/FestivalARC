...
export function DaySelector({
  ...
  return (
    <div className='bg-25-black flex items-center justify-center rounded px-4 py-2'>
      <button
        ...
        className={cn(
          'text-25-white hover:text-25-accent flex size-8 shrink-0 cursor-pointer items-center justify-center rounded transition-colors duration-200',
      ...
      <button
        ...
        className={cn(
          'text-25-white hover:text-25-accent flex h-8 w-8 shrink-0 cursor-pointer items-center justify-center rounded transition-colors duration-200',
